 ...
 * @author Salvador
 */
public class Nivel_Bob extends JPanel{
    //                      x      y
    //tamaño de cuadro     1843 * 1276
    //tamaño de las piezas 369  * 425
    ...
    public Nivel_Bob(Frame fr){
        ...
        f = new ImageIcon(getClass().getResource("/recursos/nivelBob/fondo.png"));
        ejemplo= new ImageIcon(getClass().getResource("/recursos/nivelBob/ejemplo.png"));
        
        obtenerDimensionCentral();
        piezas[0] = new Pieza("nivelBob/p1",generador.nextInt(900),generador.nextInt(500),0,0,centro.width,centro.height);
        piezas[1] = new Pieza("nivelBob/p2",generador.nextInt(900),generador.nextInt(500),369,0,centro.width,centro.height);
        piezas[2] = new Pieza("nivelBob/p3",generador.nextInt(900),generador.nextInt(500),738,0,centro.width,centro.height);
        piezas[3] = new Pieza("nivelBob/p4",generador.nextInt(900),generador.nextInt(500),1107,0,centro.width,centro.height);
        piezas[4] = new Pieza("nivelBob/p5",generador.nextInt(900),generador.nextInt(500),1476,0,centro.width,centro.height);
        piezas[5] = new Pieza("nivelBob/p6",generador.nextInt(900),generador.nextInt(500),0,425,centro.width,centro.height);
        piezas[6] = new Pieza("nivelBob/p7",generador.nextInt(900),generador.nextInt(500),369,425,centro.width,centro.height);
        piezas[7] = new Pieza("nivelBob/p8",generador.nextInt(900),generador.nextInt(500),738,425,centro.width,centro.height);
        piezas[8] = new Pieza("nivelBob/p9",generador.nextInt(900),generador.nextInt(500),1107,425,centro.width,centro.height);
        piezas[9] = new Pieza("nivelBob/p10",generador.nextInt(900),generador.nextInt(500),1476,425,centro.width,centro.height);
        piezas[10] = new Pieza("nivelBob/p11",generador.nextInt(900),generador.nextInt(500),0,850-2,centro.width,centro.height);
        piezas[11] = new Pieza("nivelBob/p12",generador.nextInt(900),generador.nextInt(500),369,850-2,centro.width,centro.height);
        piezas[12] = new Pieza("nivelBob/p13",generador.nextInt(900),generador.nextInt(500),738,850-2,centro.width,centro.height);
        piezas[13] = new Pieza("nivelBob/p14",generador.nextInt(900),generador.nextInt(500),1107,850-2,centro.width,centro.height);
        piezas[14] = new Pieza("nivelBob/p15",generador.nextInt(900),generador.nextInt(500),1476,850-2,centro.width,centro.height);
    ...
    public void paintComponent(Graphics g){
        ...
        g2d.drawImage(f.getImage(),centro.width,centro.height,f.getIconWidth()/3,(f.getIconHeight()/3)-2,this);
